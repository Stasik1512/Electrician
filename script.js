...
const questions = 
{
    ...
    tools: [
        ...
        { q: "Что измеряет мультиметр?", a: "Для определения напряжения, тока и сопротивления.", img: "https://main-cdn.sbermegamarket.ru/big1/hlr-system/-29/769/740/492/523/35/100041419446b0.jpg" },
        { q: "Что измеряют токоизмерительные клещи ?", a: "Силу тока без разрыва цепи.", img :"https://ir.ozone.ru/s3/multimedia-o/6009361104.jpg. " },
        { q: "Для чего нужен мегаомметр?", a: "Для измерения сопротивления изоляции (в мегаомах) под повышенным напряжением.", img:"https://www.geo-st.ru/upload/thumbs/325/3257d0c1992a7a0d351aefb09de1935e.jpg. "},
        { q: "Для чего нужна индикаторная отвертка?", a: "Для определения наличия напряжения (фазы) на контакте",img:"https://cdn.vseinstrumenti.ru/images/goods/ruchnoj-instrument/elektromontazhnyj-instrument-i-prisposobleniya/1226302/2400x1600/167473103.jpg."}, 
    ]
};
